    ...
    {passed
      ...
      : `You Did Not Reach The Passing Score`}
        ...
        <div className="score-card">
          ...
          <h2 className="score-number">{totalScore}</h2>
          <p className="score-sub">out of 180 points</p>
          ...
          {sectionScores.map((s, i) => (
            <div key={s.name} className={`section-card card-${i}`}>
              <div className="section-header">
                ...
                <span className="section-score">{s.score}</span>
              </div>

              <div className="section-bar">
                <div
                  className="section-fill"
                  style={{ width: `${(s.score / 60) * 100}%` }}
                />
              </div>
            </div>
          ))}
